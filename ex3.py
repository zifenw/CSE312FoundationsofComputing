...
def make_lists(n:int) -> Tuple[List[int], List[int]]:
    ...
    """
    # TODO
    l2 = l1[:-1]  # Remove the last element of l1
    l2.append(312)  # Add 312 to the end of l2 or we can use l2 = l2 +[312] 
    ...
    # TODO
    del l2[-2]
    # l2.pop(-2)  # Removes the second-last element from l2
